...
export function EditInvoicePageClient({ id }: { id: string }) {
  ...
  if (result?.error) {
    return (
      <div>
        ...
        <p style={{ fontSize: "var(--text-body-sm)", opacity: 0.55, margin: "0 0 16px" }}>
          Deze factuur bestaat niet (meer) of de link klopt niet.
        </p>
